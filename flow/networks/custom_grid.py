...
class CustomGrid(Network):
    ...
    * **speed_limit** : speed limit for all edges. This may be represented as a
    ...
    def gen_custom_start_pos(cls, net_params, initial_config, num_vehicles):
        ...
        car_nums_col=num_vehicles//4//col_num+1
        car_nums_row=num_vehicles//4//row_num+1

        cars_heading_left = car_nums_col
        cars_heading_right =car_nums_col
        cars_heading_top =car_nums_row
        cars_heading_bot = car_nums_row
