...
Check [here](https://ray.readthedocs.io/en/latest/rllib-algorithms.html#qmix-monotonic-value-factorisation-qmix-vdn-iqn)
Is says to use either MADDPG or  MARWIL.
...
Alternatively, one can use model-based policy optimization which can learn optimal policies via back-propagation, 
...
[Here's the paper](https://arxiv.org/abs/1706.02275) and [here's the implemenation](https://github.com/openai/maddpg).
...
Check [this](https://ray.readthedocs.io/en/latest/rllib-env.html) for model type
